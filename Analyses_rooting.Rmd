...
```{r boxplot1, echo=T, eval=T, fig.cap="Boxplot comparing number of roots per shoot tip of diploid Artemisia tridentata subsp. tridentata sorted by treatment. Rankings are based on Tukey tests using letters (see text for more details).", out.width="100%"}
###~~~
...
rownames(mat_data)[toAdd] <- paste0(rownames(mat_data)[toAdd], c(" (P2)", " (P1)", " (P3)"))
