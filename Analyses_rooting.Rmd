...
#boxplot(as.numeric(x$X5_w_height) ~ as.vector(x$SeedID), names = paste(names(seedID), as.vector(seedID), sep = "\n"), las=2, xlab = "", cex=.8)
```

## Statistical analyses

Here, we will use ANOVAs followed by Tukey tests to test whether treatment or individual predicted survival of plantlets and also to test whether plantlet heights after 5-weeks of culture is predicted by the number of roots of the shoot tips.

### Treatment or individual effect on plantlet survival
...
###~~~
anovaOUTsurv<- aov(X5_w_survival ~ Treat * SeedID, data = survheig)
