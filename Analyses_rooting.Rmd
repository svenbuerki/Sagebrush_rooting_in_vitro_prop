...
- (a) Shoot tips in control are significantly producing more calli than in the other treatments (`***`).
- (b) No significant differences between IBA_1, IBA_05, NAA_01 and NAA_05.

#### Investigate individual effect

We are using the same approach as with the treatment to perform pairwise comparisons to indetify individuals that are significantly producing calli independently of treatment. The tests concluded that although the `glm` supported some individual effect, none of the individuals are significantly different based on the post hoc tests.
